                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                @if (!env('HIDE_GANHADORES'))
                                    <li class="nav-item">
                                        <a href="{{ route('painel.ganhadores') }}" class="nav-link {{ request()->is('admin-ganhadores*') ? 'active' : '' }}" id="meus-sorteios">
                                ...
                                @endif
                                <li class="nav-item">
                                    <a href="{{ route('wpp.index') }}" class="nav-link {{ request()->is('wpp-mensagens*') ? 'active' : '' }}" id="wpp-msgs">
                                        <i class="fab fa-whatsapp"></i>
                                        <p>Whatsapp mensagens</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('tutoriais') }}" class="nav-link {{ request()->is('tutoriais*') ? 'active' : '' }}" id="wpp-msgs">
