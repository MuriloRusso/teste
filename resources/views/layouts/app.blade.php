...
<body>
                    ...
                    <div class="container container-600">
                        <nav class="nav-vertical nav-submenu font-xs mb-2">
                            <ul>
                                ...
                                <li><a class="text-white" alt="Sorteios" href="/"><i
                                ...
                                <li><a alt="Termos de uso" class="text-white" href="{{ route('terms') }}"><i
                                            class="icone bi bi-blockquote-right"></i><span>Termos de
                                            uso</span></a></li>
                                </li>
                            </ul>
                        </nav>
    ...
    <div class="row  d-flex mt-5">
        <!--<a href="https://api.whatsapp.com/send/?phone=5541996285726" id="btn-ctt-whatsapp" style="margin-top: 5px;" target="_blank" class="visible"><label id="wa_msg_ctt"><i class="bi bi-whatsapp"></i></label></a>

       <a href="https://chat.whatsapp.com/EjrmnV9LpMG8DJxivuFUuo" id="btn-ctt-whatsapp" target="_blank" class="visible"><label id="wa_msg_ctt"><i class="bi bi-whatsapp"></i> GRUPO</label></a>
...
@endif
       ...
       <a href="https://t.me/+kseyi6M41JhhNGMx" style="right: 0;
    bottom: 0;
    position: fixed;
            ...
            <div class="container" style="text-align: center; padding-top: 5px;padding-bottom: 5px;">
                ...
                @if (env('FOOTER_CLIENTE'))
                    ...
                    <a href="https://apostanarifa.com.br/" target="_blank" style="text-decoration: none"><span
                            class="text-muted" style="color: #fff!important; font-size: 12px;">Desenvolvido por HD
                            PRODUTORA</span></a>
                @endif
            </div>
        </footer>
