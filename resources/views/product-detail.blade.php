...
@section('content')
    ...
    <!-- <script>
        ...
        const btnClick = () => {
            ...
            let tel = document.getElementById('telephone1').value;

            // alert(tel);
            console.log(tel.value); 

            const response = await fetch ('http://127.0.0.1:8000/cadastra-participanteAuto', 
    ...
    <script>
        ...
        function validarCel() {
           ...
           let tel = document.querySelector('#staticBackdrop #telephonePre').value;
           ...
           if (qtd > disponivel) {
               ...
               $('#staticBackdrop2').modal('show')
                ...
                setTimeout(function(){
                    ...
                    document.querySelector('#staticBackdrop2 #telephone1').value = tel;

                        const dates = fetch('').then(function(resposta){
