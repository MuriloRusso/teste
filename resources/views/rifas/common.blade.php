...
<div class="mt-2 d-flex text-center justify-content-center">
    <div class="text-center">
        <center>
            ...
            <!-- Telegram -->
            <a class="btn btn-primary" style="background-color: #2F9DDF;border: none;" href="https://t.me/+556984465865"
                target="_blank" rel="noreferrer noopener" role="button"><i class="bi bi-telegram"
