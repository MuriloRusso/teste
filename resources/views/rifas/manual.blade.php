...
<input type="number"
                        style="text-align: center;background-color: #E5E5E5;color: #000000;font-weight: bold; display:none"
...
<div class="d-flex justify-content-between font-weight-600 mb-2">
    <div class="seletor-item rounded d-flex justify-content-between box-shadow-08 font-xs" style="cursor: pointer;" onclick="showNumbers('disponivel')">
    ...
    <div class="seletor-item rounded d-flex justify-content-between box-shadow-08 font-xs" style="cursor: pointer;" onclick="showNumbers('reservado')">
        <div class="nome bg-white rounded-start text-dark p-2">
            Reserv
        </div>
    ...
    <div class="seletor-item rounded d-flex justify-content-between box-shadow-08 font-xs" style="cursor: pointer;" onclick="showNumbers('pago')">
        <div class="nome bg-white rounded-start text-dark p-2">
            Pagos
        </div>
...
<div class="d-flex justify-content-center">
    <div class="payment" id="payment"
        style="display: none; width: 500px !important;margin-bottom: 10px;">
