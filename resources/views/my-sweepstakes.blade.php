                        ...
                        <div class="row mb-3">
                            ...
                            <div class="row-12 mb-3 d-flex" style="justify-content: space-between;">
                                ...
                                <form method="GET" class="form-inline my-2 my-lg-0">
                                    ...
                                    <button class="btn btn-outline-secondary my-2 my-sm-0 border border-primary bg-primary text-white text-dark"
                                        ...
                                        <td style="width: 20%">
                                            ...
                                            @else
                                                ...
                                                {{-- <form action="{{ url('edit-product/' . $product->id) }}" method="POST"
                                                    ...
                                                    <a href="#modal_editar_rifa{{ $product->id }}"
                                                        class="edit btn btn-warning" data-bs-toggle="modal"
                                                        data-bs-target="#modal_editar_rifa{{ $product->id }}"><i
                                                            class="bi bi-pencil-square"></i></a>

                                                    <a href="#deleteEmployeeModal{{ $product->id }}"
                                                        class="delete btn btn-danger" data-toggle="modal"
                                                        data-bs-target="#deleteEmployeeModal{{ $product->id }}"
                                                        data-id="{{ $product->id }}"><i class="bi bi-trash3"></i></a>

                                                    <a href="{{ route('resumoRifaPDF', $product->id) }}" target="_blank"
                                                        class="edit btn btn-secondary"><i class="far fa-file-pdf"></i></a>

                                                    <a href="javascript:void(0)" title="Ranking"
                                                        onclick="openRanking('{{ $product->id }}')"
                                                        class="edit btn btn-info"><i class="fas fa-award"></i></a>
                                                </form> --}}
                                            @endif
                                        </td>
